    ...
    <div className="h-screen bg-bg-base flex flex-col font-sans text-text-primary">
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar flex flex-col items-center py-12 px-8 bg-bg-base">
          <div className="w-full max-w-[780px] min-h-[calc(100vh-200px)] h-fit shrink-0 bg-bg-surface border border-border-subtle rounded-xl py-12 px-14 shadow-md flex flex-col">
            <textarea
              ref={textareaRef}
